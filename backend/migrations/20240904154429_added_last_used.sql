...
CREATE TABLE `new_Resource` (
  ...
  `last_used` integer NULL DEFAULT 0,
  `file` integer NULL,
  `type` varchar NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `new_Resource` (`id`, `name`, `last_usage`, `deleted`, `file`, `type`) SELECT `id`, `name`, `last_usage`, `deleted`, `file`, `type` FROM `Resource`;
