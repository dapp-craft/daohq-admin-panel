...
CREATE TABLE `new_Slot` (
  ...
  `trigger` boolean NULL DEFAULT FALSE,
...
INSERT INTO `new_Slot` (`id`, `name`, `supports_streaming`, `format`, `location`) SELECT `id`, `name`, `supports_streaming`, `format`, `location` FROM `Slot`;
